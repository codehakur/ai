...
if __name__ == '__main__':
    inputQueries_, inputSentences_ = getInput("C:\Users\akash\Desktop\RA1911003010667\LAB 7\Input.txt")
    knowledgeBase = KB(inputSentences_)
    knowledgeBase.prepareKB()
    results_ = knowledgeBase.askQueries(inputQueries_)
    printOutput("C:\Users\akash\Desktop\RA1911003010667\LAB 7\Output.txt", results_)